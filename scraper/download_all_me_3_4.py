...
# Generate roll numbers: 231391034001 to 231391034045 + Lateral 241391034501 to 241391034520
rolls = [f"231391034{i:03d}" for i in range(1, 46)]
lateral_rolls = [f"2413910345{i:02d}" for i in range(1, 21)]
all_rolls = rolls + lateral_rolls

COURSES = [
    ("1034203", "B.Tech (Mechanical Engg) III Semester", DIR_SEM_III, 3),
    ("1034204", "B.Tech (Mechanical Engg) IV Semester", DIR_SEM_IV, 4)
]
...
def fetch_single_me(roll, course_code, course_name, target_dir, sem_num, tokens):
...
for course_code, course_name, target_dir, sem_num in COURSES:
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:
        futures = {executor.submit(fetch_single_me, roll, course_code, course_name, target_dir, sem_num, tokens): roll for roll in all_rolls}
